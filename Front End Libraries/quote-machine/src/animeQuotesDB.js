...
anime_quote[8] = {
  quotenumber: 9,
  quotesentence:
    "Only God knows who shall be the victor. I can only do the best I can.",
...
anime_quote[9] = {
  quotenumber: 10,
  quotesentence:
    "Those aren’t tears of sadness. They’re tears of happiness, right? Let us make haste, lest the wind ceases.",
...
anime_quote[28] = {
  quotenumber: 29,
  quotesentence:
    "There is nothing that you can acquire without making a move on your own. It's the same with romance - your only hope is to be more aggressive.",
...
anime_quote[34] = {
  quotenumber: 35,
  quotesentence:
    "Wishes are great because they don’t come true. We work hard because they don’t. We constantly push ourselves forward precisely because they don’t come true. But once they do what’s left to keep driving us forward?",
...
anime_quote[36] = {
  quotenumber: 37,
  quotesentence:
    "I always have this feeling... The feeling that I'm losing something. The world is really beautiful, but... it feels like it's just me... who's drifting away from it.",
